...
layout: essay
type: essay
title: "Agile and Organized: My Journey in Software Engineering"
...
- **Milestone 1**: Designed the Sign-Up page.
- **Milestone 2**: Implemented the database connection.
- **Milestone 3**: Optimized the UI.
...
- In game development, it can be used to divide tasks such as character movement implementation, level design, and testing.
- In personal life, Agile principles can help distribute time and tasks efficiently and provide opportunities for reflection, creating a more organized and productive lifestyle.
...
- After modifying the database schema, I did not inform my team, which caused a conflict with the UI code.
...
- In design projects, it can track file versions and prevent merge conflicts when team members work on the same graphic files.
- In research projects, it can manage changes in data analysis scripts.
- In team projects, it can track documentation updates systematically.
